...
public class OmnidroidV0Model extends EntityModel<OmnidroidRenderState> {
	...
	public OmnidroidV0Model(ModelPart root) {
		...
		this.leg_front_left_2 = leg_front_left.getChild("leg_front_left_2");
		this.leg_front_lef_3 = leg_front_left_2.getChild("leg_front_lef_3");
		this.leg_front_left_4 = leg_front_lef_3.getChild("leg_front_left_4");
		this.leg_back_left = body.getChild("leg_back_left");
		this.leg_back_left_2 = leg_back_left.getChild("leg_back_left_2");
		...
		this.leg_front_right_2 = leg_front_right.getChild("leg_front_right_2");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData mob = modelPartData.addChild("mob", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 17.0F, 0.0F));

		ModelPartData head = mob.addChild("head", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -5.0F, 0.0F));
		...
		.uv(62, 56).cuboid(-5.0F, -8.0F, -2.5F, 10.0F, 5.5F, 5.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData body = mob.addChild("body", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0179F, 0.0F));
		...
		.uv(64, 11).cuboid(-5.0F, -2.7679F, -2.5F, 10.0F, 5.5F, 5.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
